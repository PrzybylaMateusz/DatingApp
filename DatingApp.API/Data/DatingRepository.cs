...
namespace DatingApp.API.Data
{
    public class DatingRepository : IDatingRepository
    {
        ...
        {
            var user = this.context.Users.Include(p => p.Photos).FirstOrDefaultAsync(u => u.Id == id);
        ...
        {
            return await this.context.Messeges.FirstOrDefaultAsync(m => m.Id == id);
        }

        public async Task<PagedList<Message>> GetMessagesForUser(MessageParams messageParams)
        {
            var messages = this.context.Messeges.Include(u => u.Sender).ThenInclude(p => p.Photos)
        ...
        {
            var messages = await this.context.Messeges.Include(u => u.Sender).ThenInclude(p => p.Photos)
            .Include(u => u.Recipient).ThenInclude(p => p.Photos)
